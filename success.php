...
.payment a{background: #5f0505;color: white;font-size: 25px;padding: 5px 30px;border-radius: 3px;}
...
.back a{width: 160px;margin: 5px auto 0; padding: 7px 0px;text-align: center;display: block;background: #555;border: 1px solid #333;color:#fff;border-radius: 3px;font-size: 20px;}
 ...
 <div class="main">
    <div class="content">
        ...
        <div class="payment">
          <h2>Successfull!</h2>
          <p><h3>Your Order Is Successfully Placed!!</h3></p>
          <br>
          <br><br>
          <p><a href="order.php">Order Details</a> </p>
        </div>
