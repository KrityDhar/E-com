		   ...
		   <!-- FlexSlider -->
			...
			<section class="slider">
				  <div class="flexslider">
					<ul class="slides">
						<li><img src="images/y2t_1023x426.jpg" alt=""/></li>
						<li><img src="images/y3_1023x426.jpg" alt=""/></li>
						<li><img src="images/u2_1023x426.jpg" alt=""/></li>
						<li><img src="images/u3_1023x426.jpg" alt=""/></li>
				    </ul>
				  </div>
	      </section>
<!-- FlexSlider -->
